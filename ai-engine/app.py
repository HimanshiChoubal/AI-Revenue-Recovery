...
# --------------------------------------------------------------------------
# Schemas (Fixed for Java camelCase interoperability)
# --------------------------------------------------------------------------
...
class DiagnoseRequest(BaseModel):
    ...
    attempts_so_far: int = Field(0, ge=0, alias="attemptsSoFar")
...
class DiagnoseResponse(BaseModel):
    ...
    outreach_script: Optional[str] = Field(None, alias="outreachScript")
    target_rail: str = Field(..., alias="targetRail")
    recovery_probability: float = Field(..., alias="recoveryProbability")
